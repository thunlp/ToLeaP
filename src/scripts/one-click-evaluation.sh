...
python taskbench_eval.py \
    --model $MODEL_PATH \
    --data_path ../data/sft_data/TaskBench/taskbench_data_huggingface.json \
    --is_api False
python taskbench_eval.py \
    --model $MODEL_PATH \
    --data_path ../data/sft_data/TaskBench/taskbench_data_dailylifeapis.json \
    --is_api False
python taskbench_eval.py \
    --model $MODEL_PATH \
    --data_path ../data/sft_data/TaskBench/taskbench_data_multimedia.json \
    --is_api False
