# This file is to obtain the taskbench data.
# Author: Litu Ou, Zijun Song
# Date: 2025-04
...
for split in splits:
    ...
    while True:
        try:
            ...
            json.dump(tool_descs[split], open(f'../../../data/taskbench/tool_desc_{split}.json', 'w'), indent=2)
            break
...
if __name__ == "__main__":
    for split in splits:
        ...
        os.makedirs(f'../../../data/taskbench', exist_ok=True)
        with open(f'../../../data/taskbench/taskbench_data_{split}.json', 'w') as f:
