...
class QueryMeeting(API):
    ...
    output_parameters = {
        'meeting_info': {'type': 'json', 'description': 'meeting info'}
    }
    ...
    def call(self, token: str, meeting_topic: str, start_time: str, end_time: str, location: str,
        ...
        try:
            status = self.query_meeting(token, meeting_topic, start_time, end_time, location, attendees)
    ...
    def query_meeting(self, token: str, meeting_topic: str, start_time: str, end_time: str, location: str,
                       attendees: list) -> str:
